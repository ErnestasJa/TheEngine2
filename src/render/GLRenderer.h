...
class GLRenderer : public IRenderer
{
  ...
  core::UniquePtr<IGpuBufferArrayObject> CreateBufferArrayObject(
  ...
  void RenderMesh(BaseMesh* mesh, material::BaseMaterial* material,
                  const glm::mat4 transform) final;
  void RenderMesh(AnimatedMesh* mesh, material::BaseMaterial* material,
                  const glm::mat4 transform) final;
